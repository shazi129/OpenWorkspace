...
| 添加文章、模块或部署站点 | [`安装与内容创作`](../安装文档.md)、[`workspace 说明`](../../workspace/README.md) | `<workspaceRoot>/modules/`、`<workspaceRoot>/deploy/` |
| 修改 API、动态模块或全局私有服务 | [`服务运行时`](../architecture/modules/service-runtime.md)、[`工作区与生成目录选择 spec`](../specs/workspace-selection.md) | `src/server/`、`<workspaceRoot>/services/` |
